              ...
              <DropdownMenuContent className="w-80">
                <DropdownMenuItem>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      BIZ scales apps to meet user demand, automagically, based
                      on load.
                    </div>
                  </div>
                </DropdownMenuItem>
                ...
                <DropdownMenuItem>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      BIZ runs on BIZ, join us and others serving requests at
                      web scale.
                    </div>
                  </div>
                </DropdownMenuItem>
          ...
          {isMenuOpen && (
            ...
            >
              ...
              >
                ...
                >
                  <Link
                    href="https://www.facebook.com/profile.php?id=61553430196810"
                    target="_blank"
