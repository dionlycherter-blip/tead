    ...
    <div className="relative justify-center items-center">
      <section className="max-w-(--breakpoint-xl) mx-auto px-4 py-28 gap-12 md:px-8 flex flex-col justify-center items-center">
        ...
        >
          ...
          <h1 className="text-4xl font-heading font-extrabold tracking-tighter mx-auto md:text-5xl text-pretty bg-linear-to-b from-sky-800 dark:from-sky-100 to-foreground dark:to-foreground bg-clip-text text-transparent">
            BIZ CASH CREDITS
          </h1>
          <p className="max-w-2xl text-lg mx-auto text-muted-foreground text-balance">
            สินเชื่อเสริมสภาพคล่องสำหรับเจ้าของธุรกิจ
          </p>
          <motion.div
              ...
              <DialogContent>
                ...
                <DialogFooter>
                  <Button asChild size="sm">
                    <Link href="https://www.facebook.com/profile.php?id=61553430196810" target="_blank">
                      Connect on{" "}
                      <svg
